...
jest.mock('../contexts/AuthContext', () => ({ useAuth: () => ({ user: { email: 'jamie@example.com' }, signOut: jest.fn() }) }));
...
const mount = () => render(<QueryClientProvider client={new QueryClient()}><Profile /></QueryClientProvider>);
beforeEach(() => {
  jest.clearAllMocks();
