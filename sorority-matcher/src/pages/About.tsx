      ...
      <div className="max-w-3xl w-full flex flex-col gap-8">
        ...
        <section className="bg-white rounded-lg shadow-sm p-5">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold mb-2">1. Mutual-First-Choice Matches</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">2. Deferred Acceptance (the NRMP Algorithm)</h3>
              <p className="text-lg leading-relaxed text-gray-700">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">3. Twins</h3>
              <p className="text-lg leading-relaxed text-gray-700">
